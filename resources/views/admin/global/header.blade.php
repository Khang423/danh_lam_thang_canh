 ...
 <div class="page-header">
     <div class="header-wrapper row m-0">
         <div class="header-logo-wrapper col-auto p-0">
             <div class="logo-wrapper"><a href="index.html"><img class="img-fluid main-logo"
                         src="{{ asset('assets/systems/logo.png') }}" alt="logo">
                     <img class="img-fluid white-logo" src="{{ asset('assets/systems/logo-white.png') }}"
                         alt="logo"></a>
             </div>
             <div class="toggle-sidebar"><i class="fa-solid fa-bars"></i>
             </div>
         </div>
         ...
         <div class="nav-right col-4 pull-right right-header p-0">
             <ul class="nav-menus">
                 ...
                 <li class="onhover-dropdown">
                     <div class="notification-box"><i class="fa-regular fa-bell"></i><span
                 ...
                 <li>
                     <div class="mode"><i class="fa-regular fa-moon"></i>
                     </div>
                 </li>

                 <li class="onhover-dropdown"><i class="fa-regular fa-message"></i>
                 ...
                 <li class="maximize"><a class="text-dark" href="#!" onclick="javascript:toggleFullScreen()"><i
                             class="fa-solid fa-expand"></i></a></li>
                 <li class="profile-nav onhover-dropdown pe-0 me-0">
                     <div class="media profile-media">
                         <img class="user-profile rounded-circle" src="{{ asset('assets/systems/4(1).jpg') }}"
                             alt="profile-picture">
    ...
    <div class="ProfileCard-realName">Khang</div>
    </div>
    </div>
</script>
